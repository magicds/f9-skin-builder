  ...
  render: h => h(App, {
    props: {
      ...
      "advancedRules": [{
        ...
        "value": "rgb(red(@primary-color) + 15, green(@primary-color) + 15, blue(@primary-color) + 15)",
        "tips": "主色调rgb都提高15"
      }, {
        "name": "主要按钮悬浮色",
        "key": "@lesser-hover-color1",
        "value": "rgb(red(@lesser-color1) + 15, green(@lesser-color1) + 15, blue(@lesser-color1) + 15)",
        "tips": "辅助色1 rgb都提高15"
      }, {
        "name": "信息按钮悬浮色",
        "key": "@lesser-hover-color2",
        "value": "rgb(red(@lesser-color2) + 15, green(@lesser-color2) + 15, blue(@lesser-color2) + 15)",
        "tips": "辅助色2 rgb都提高15"
      }],
      less: `// 此文件由合并 frame/*.less 生成
      // =============================
      // 框架样式部分
      .fui-accordions {}
